...
if __name__ == '__main__':
    ...
    train_mses, test_mses = net.train(dataset, test_dataset, sys.argv[3], patience=20, warm_start_params=warm_start_params,  warm_start_last_epoch=warm_start_last_epoch, max_iter=max_iter)
    exit()
